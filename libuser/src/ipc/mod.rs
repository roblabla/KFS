...
pub trait SizedIPCBuffer {
    ...
    /// # Safety
    ///
    /// [See slice::from_raw_parts](https://doc.rust-lang.org/std/slice/fn.from_raw_parts.html)
    unsafe fn from_raw_parts<'a>(addr: usize, size: usize) -> &'a Self;

    /// Create a mutable reference to a ipc buffer from an address and a byte
    /// size.
    ///
    /// # Safety
    ///
    /// [See slice::from_raw_parts_mut](https://doc.rust-lang.org/std/slice/fn.from_raw_parts_mut.html)
